...
class StringFormatterTest extends TestCase
{
	...
	{
		$this->assertSame("HelloWorld", self::$stringFormatter->suffix(self::$str1, self::$str2, true));
		$this->assertSame("HelloWorlD", self::$stringFormatter->suffix(self::$str1, self::$str2));
	}
}
